...
Therefore I am evaluating:

1. The average delay of the mentioned flight number is assigned to each tweet, calculated from the data of `departure_data`.

2. Each tweet is assigned the average delay of the mentioned flight number in the year and month in which the tweet was posted. For example, if a tweet was posted in January 2021, with the flight number LH1234, then the average delay of LH1234 in January 2021 is assigned to the tweet, calculated on the basis of `departure_data`.

Independently, I am still evaluating: 

3. Is there a correlation between the number of tweets mentioning a flight number and the average delay of the flight (flight number).
...
1. Add delay of each flight number based on month/year
...
2. Add delay of each flight number
