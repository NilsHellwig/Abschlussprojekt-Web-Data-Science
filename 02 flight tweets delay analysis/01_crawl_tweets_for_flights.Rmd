...
### Install Snscrape
Due to the fact that this is a Python-based tool, it is necessary to install it using Python.
...
Now I read down all the .json files to compile the most important information of the tweet (username, url, date, content etc.) into a single csv file
