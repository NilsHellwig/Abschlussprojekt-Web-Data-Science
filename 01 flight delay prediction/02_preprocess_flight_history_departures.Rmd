...
This notebook is used to preprocess the downloaded .html files of the departure flights to assemble them into a neatly formatted dataframe. This script takes about an hour to run (at least that was the case with my M1 MacBook). This is not due to the use of for loops, this is due to many regular expressions used to extract the flight data.
